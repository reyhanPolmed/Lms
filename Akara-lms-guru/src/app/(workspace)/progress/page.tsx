  ...
  return (
    <div className="space-y-5 pb-6">
      <PageHeader
        ...
        description="Mulai dari kelas untuk menemukan mahasiswa berisiko, progres tertahan, dan mata kuliah yang perlu intervensi."
      />
      ...
      <Surface title="Daftar Kelas" description="Ringkasan progres per kelas untuk memprioritaskan pemantauan.">
        {loading ? (
          <LoadingState
            ...
            description="Mengambil progres mahasiswa dan menyusun ringkasan berdasarkan kelas."
          />
        ) : error ? (
          ...
          <EmptyState
            ...
            description="Data progres akan tampil setelah mahasiswa mulai mengakses modul pembelajaran."
          />
        ) : (
