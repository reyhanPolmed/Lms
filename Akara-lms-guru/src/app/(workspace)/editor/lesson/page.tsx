      ...
      <section className="grid min-h-0 gap-2 xl:grid-cols-[1.3fr_0.9fr]">
        <Surface title="Form Materi">
          <div className="grid gap-2">
            ...
            <label className="block">
              ...
              <textarea className="h-42 w-full rounded-[10px] border border-[rgba(113,94,215,0.12)] bg-white p-3 text-[13px] text-[#4f5678] outline-none" />
            </label>
            <div className="grid gap-2 md:grid-cols-2">
        ...
        <Surface title="Preview Siswa">
          <article className="rounded-[12px] border border-[rgba(113,94,215,0.12)] bg-white p-3">
            ...
            <p className="mt-1 text-[12px] text-[#565f7d]">Tipe: Text - Durasi: 12 menit</p>
            <div className="mt-3 rounded-[10px] bg-[#faf8ff] p-2.5 text-[12px] leading-5 text-[#535b84]">
