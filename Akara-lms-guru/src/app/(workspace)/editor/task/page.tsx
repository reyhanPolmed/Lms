    ...
    <div className="grid min-h-full grid-rows-[auto_minmax(0,1fr)] gap-2">
      ...
      <section className="grid min-h-0 gap-2 xl:grid-cols-[1.35fr_0.85fr]">
        <Surface title="Form Tugas">
          <div className="grid gap-2">
            ...
            <label className="block">
              ...
              <textarea className="h-28 w-full rounded-[10px] border border-[rgba(113,94,215,0.12)] bg-white p-3 text-[13px] text-[#4f5678] outline-none" />
            </label>
            <label className="block">
              <span className="mb-1 block text-[12px] font-semibold uppercase tracking-[0.16em] text-[#626b8b]">
                Checklist Submission
              </span>
              <textarea className="h-20 w-full rounded-[10px] border border-[rgba(113,94,215,0.12)] bg-white p-3 text-[13px] text-[#4f5678] outline-none" placeholder="- Lampiran PDF&#10;- Link referensi&#10;- Ringkasan 200 kata" />
            </label>
            <label className="block">
              <span className="mb-1 block text-[12px] font-semibold uppercase tracking-[0.16em] text-[#626b8b]">
                Rubrik Ringkas (3-6 kriteria)
              </span>
              <textarea className="h-24 w-full rounded-[10px] border border-[rgba(113,94,215,0.12)] bg-white p-3 text-[13px] text-[#4f5678] outline-none" placeholder="- Akurasi konsep (30)&#10;- Analisis (40)&#10;- Struktur jawaban (30)" />
            </label>
        ...
        <Surface title="Panel Penilaian Cepat">
          <div className="space-y-2 text-[12px] text-[#565f7d]">
